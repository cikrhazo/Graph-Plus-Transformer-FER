...
class OuluSet(data.Dataset):
    '''
        ...
        6: Anger     5
        '''
    def __init__(self, root="/media/ruizhao/programs/datasets/Face/Oulu-CASIA/Oulu_Video/",
                 out_size=224, window_size=49, online_ldm=False, num_frame=16, valid=0, train=True):

        self.root = root
        self.root_ldm = "/media/ruizhao/programs/datasets/Face/Oulu-CASIA/Oulu_Video_ldm/"
...
if __name__ == "__main__":
    ValidSet = OuluSet(root="/media/ruizhao/programs/datasets/Face/Oulu-CASIA/Oulu_Video/",
                       valid=0, train=True, online_ldm=True)
    ValidLoader = data.DataLoader(ValidSet, batch_size=2, num_workers=0, shuffle=False, pin_memory=False)
